...
public class BoardColumnDAO {
	...
	public BoardColumnEntity insert(final BoardColumnEntity entity) throws SQLException {
        ...
        try(var statement = connection.prepareStatement(sql)){
            ...
            statement.setLong(i, (long) entity.getBoard().getId());
    ...
    public List<BoardColumnEntity> findByBoardId(final Object object) throws SQLException{
    ...
    public List<BoardColumnDTO> findByBoardIdWithDetails(final Object object) throws SQLException {
